...
const traffic=[
    ...
    new Car(road.getLaneCenter(4),-100,30,150, "DUMMY", 3),
    new Car(road.getLaneCenter(1),-100,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(0),-1000,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(1),-800,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(1),-600,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(4),-700,30,150, "DUMMY", 3),
    new Car(road.getLaneCenter(2),-1800,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(3),-800,30,50, "DUMMY", 3),
    new Car(road.getLaneCenter(4),-100,30,150, "DUMMY", 3)
]
